...
from helper import DOCKER_CHECKER_PATH, PYTHON_INSTALLER_PATH, DOCKER_RESTARTER_PATH, SETUP_CRONTAB_PATH, \
    RIVALZ_RESTARTER, SCREEN_CHECKER
...
if __name__ == '__main__':
    ...
    ssh.send_files_give_permission(RIVALZ_RESTARTER, "/root/modules/rivalz_restarter.sh")
    ssh.send_files_give_permission(SCREEN_CHECKER, "/root/modules/screen_checker.py")
